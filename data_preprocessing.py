...
if __name__ == "__main__":
    ...
    # df_samples = pd.read_csv("matching_questions_filtered.csv")
    ...
    #         emb_file_list.append(f"/media/user/data/polymarket/data/embbeding/emb_{prev_i+1:04d}.pt")
    #         graph_file_list.append(f"/media/user/data/polymarket/data/graph/graph_{prev_i+1:04d}.pt")
    #         continue
    ...
    #     audio_features = audio_model.extract_from_audio_folder().to("cpu").squeeze() # X_A [ N_U, 768 ]
    ...
    #     # 그래프 데이터 저장
    #     torch.save(emb, f"/media/user/data/polymarket/data/embbeding/emb_{i+1:04d}.pt")
    #     torch.save(graph, f"/media/user/data/polymarket/data/graph/graph_{i+1:04d}.pt")

    #     emb_file_list.append(f"/media/user/data/polymarket/data/embbeding/emb_{i+1:04d}.pt")
    #     graph_file_list.append(f"/media/user/data/polymarket/data/graph/graph_{i+1:04d}.pt")

    #     prev_url = url
    #     prev_i = i

    # # Save the list of files
    # df_samples_file["emb_file"] = emb_file_list
    # df_samples_file["graph_file"] = graph_file_list
    # df_samples_file.to_csv("/media/user/data/polymarket/data/data_annotation.csv", index=False)
